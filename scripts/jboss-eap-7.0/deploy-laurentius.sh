...
cp "$LAU_BUNDLE/modules/Laurentius-msh-xsd-VERSION.jar" "$WILDFLY_HOME/modules/si/laurentius/main/"
cp "$LAU_BUNDLE/modules/Laurentius-wsdl-VERSION.jar" "$WILDFLY_HOME/modules/si/laurentius/main/"
cp "$LAU_BUNDLE/modules/Laurentius-commons-VERSION.jar" "$WILDFLY_HOME/modules/si/laurentius/main/"
cp "$LAU_BUNDLE/modules/Laurentius-lce-VERSION.jar" "$WILDFLY_HOME/modules/si/laurentius/main/"
cp "$LAU_BUNDLE/modules/Laurentius-plugin-interfaces-VERSION.jar" "$WILDFLY_HOME/modules/si/laurentius/main/"
