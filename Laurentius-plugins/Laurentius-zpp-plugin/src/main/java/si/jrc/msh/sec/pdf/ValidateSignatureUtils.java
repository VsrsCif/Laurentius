...
public final class ValidateSignatureUtils {
  ...
  public static final String SIG_SUB_FILTER_DETACHED= PDSignature.SUBFILTER_ADBE_PKCS7_DETACHED.getName();  
  
  public static final String SIG_SUB_FILTER_SHA1 = PDSignature.SUBFILTER_ADBE_PKCS7_SHA1.getName();  
  public static final String SIG_SUB_FILTER_RSA_SHA1= PDSignature.SUBFILTER_ADBE_X509_RSA_SHA1.getName();  
   ...
   */
  private X509Certificate getSignerCert(byte[] byteArray, COSString contents, PDSignature sig)
    ...
    X509Certificate certFromSignedData = new JcaX509CertificateConverter().getCertificate(
        certificateHolder);
