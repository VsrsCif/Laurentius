...
public class PDFUtil {
    ...
    public synchronized PDFContentData concatenatePdfFiles(List<File> strFiles, File outFile) throws PDFException {
        ...
        try (FileOutputStream fos = new FileOutputStream(outFile)) {
            ...
            pdfUtility.mergeDocuments(MemoryUsageSetting.setupMainMemoryOnly().streamCache);
        } catch (IOException ex) {
            String strMessage = "Error occured while creating concatenated PDF file; Exception: " + ex.getMessage();
