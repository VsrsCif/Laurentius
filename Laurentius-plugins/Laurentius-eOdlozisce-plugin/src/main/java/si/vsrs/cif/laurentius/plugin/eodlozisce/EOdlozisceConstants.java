...
public class EOdlozisceConstants {

    public static final String EODLOZISCE_PLUGIN_TYPE = "eOdlozisce";
    ...
    public static final String EODLOZISCE_SERVICE = "eOdlozisceService";
}
