...
public enum EBMSErrorCode implements EBMSErrorCodeInterface {
  ...
  DuplicateDeteced("EBMS:1000", "DuplicateDeteced", "warning",
          "Processing",
          "Message was already received in receivers duplicate detection time window! "
  ...
  ApplicationError("EBMS:1503",
          ...
          "application"),
  IgnoredAlreadyReceivedMessage("SVEV:0201", "IgnoredAlreadyReceivedMessage",
          "warning",
          "Processing",
          "Message was already received in receivers duplicate detection time window! "
          + "According to receivers settings duplicate is eliminated!",
  ...
  public static EBMSErrorCode getByCode(String code) {
    if (!Utils.isEmptyString(code)) {
      for (EBMSErrorCode ec : values()) {
