 ...
 */
package si.laurentius.test.zpp.sec;
...
public class SignUtils implements SignatureInterface {
    ...
    public void createDefaultVisualization(File pdfFile, X509Certificate xc, Date dt) {
        try (InputStream imageStream = SignUtils.class.getResourceAsStream(S_TEMPLATE_IMAGE)) {
            ...
            final PDDocument pdDocument = Loader.loadPDF(pdfFile);
            visibleSignDesigner = new PDVisibleSignDesigner(pdDocument, bimage, page);
