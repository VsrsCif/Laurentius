...
public class WSEodlozisceClientExample {
    ...
    public static final Logger LOG = Logger.getLogger(WSEodlozisceClientExample.class);
    ...
    public static void main(String... args) throws InterruptedException {
        ...
        try {
            ...
            testEvrocanje(S_KEY_NOT_REGISTRED_ALIAS);
        } catch (SEDException_Exception | JAXBException | FOPException | ZPPException ex) {
            LOG.error("Signature failed: " + ex.getMessage(), ex);
        }
    }
    ...
    private static void testEvrocanje(String singatureKey) throws SEDException_Exception, JAXBException, InterruptedException, FOPException, ZPPException {
        BasicConfigurator.configure();

        WSEodlozisceClientExample wc = new WSEodlozisceClientExample();

        // example submit mail
        BigInteger bi = wc.submitMail(createOutMail(RECEIVER_BOX, "Mr. Receiver",
                SENDER_BOX, "Mr. Sender",
                EOdlozisceConstants.EODLOZISCE_SERVICE,
                EOdlozisceConstants.EODLOZISCE_ACTION,
                "Test message",
                "VL 1/2016"));
