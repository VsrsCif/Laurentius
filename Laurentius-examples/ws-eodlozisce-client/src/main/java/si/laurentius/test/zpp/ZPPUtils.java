...
//    mout.setService(EOdlozisceConstants.EVROCANJE_SERVICE);
//    mout.setAction(EOdlozisceConstants.S_ZPP_ACTION_ADVICE_OF_DELIVERY);
...
//    mout.setSubject(EOdlozisceConstants.S_ZPP_ACTION_ADVICE_OF_DELIVERY);
...
//      mp.setDescription(EOdlozisceConstants.S_ZPP_ACTION_ADVICE_OF_DELIVERY);
...
//      mfpFop = new FOPUtils(new File(S_SETTINGS_FOLDER+ EOdlozisceConstants.FOP_CONFIG_FILENAME),
//              S_SETTINGS_FOLDER + EOdlozisceConstants.XSLT_FOLDER);
    }
    return mfpFop;
  }
