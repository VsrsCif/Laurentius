 ...
 * generated in the si.laurentius.outbox.payload package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: si.laurentius.outbox.payload
     * 
     */
